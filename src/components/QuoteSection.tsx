...
export default function QuoteSection() {
  return (
    <Section id="quote" bgImage="https://www.veslavia.com/demo/images/loveStoryImg.webp" nextId="dresscode" contentClassName="animate-fade-in-up">
      <div className="mx-auto max-w-xl text-center">
        <div className="card-glass p-6 md:p-10">
          <div className="mx-auto mb-6 h-64 w-44 overflow-hidden rounded-[2rem]">
            <Image src="https://www.veslavia.com/demo/images/quoteImg.webp" alt="couple" width={500} height={800} className="h-full w-full object-cover" />
          </div>
